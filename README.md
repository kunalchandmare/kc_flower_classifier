...
# Dataset
The model can be trained on any dataset user want but need to be relevant for Flower classification otherwise results wont be as desired. Please use recommeneded dataset provided in following link:
